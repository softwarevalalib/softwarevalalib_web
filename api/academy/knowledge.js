...
export const ACADEMY_KNOWLEDGE = {
  faq: [
    ...
    { q: "What happens after I submit?", a: "You receive a reference number immediately. Your admission letter is generated automatically (usually within 10–30 minutes) and emailed to you — admin approval is not required before the letter is sent. Admissions may follow up within 24–48 hours about orientation and payment." },
    { q: "How does enrollment work?", a: "Choose a course, click Select to enroll (or use the enrollment form), share your personal details, review the summary, and confirm. After submission you get a reference number and an automatic admission letter emailed within about 10–30 minutes." },
    { q: "Where can I download my admission letter?", a: "Your admission letter is emailed to the address on your application (usually within 10–30 minutes). If you did not receive it, contact Admissions with your reference number." },
    { q: "How do tuition payments work?", a: "Course tuition is payable in three installments: 40% first payment, 30% second payment, and 30% final payment. Registration fees are separate and listed on each course. Official merchant details are shared after your application is processed." },
