...
export default function Homehero() {
  ...
  return (
    <section className="relative overflow-hidden bg-slate-950">
      ...
      <div className="absolute top-20 right-10 w-72 h-72 bg-cyan-500/10 blur-[120px] rounded-full pointer-events-none" />

      <div className="section-container relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center section-padding">
        {/* Left: copy */}
        <div className="text-white text-center lg:text-left">
          <Reveal delay={0.1}>
            <span className="inline-flex items-center gap-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10 px-4 py-1.5 text-xs sm:text-sm font-semibold uppercase tracking-wider text-orange-400">
          ...
          <Reveal delay={0.2}>
            <h1 className="mt-5 font-display font-extrabold uppercase leading-[1.05] text-4xl sm:text-5xl lg:text-6xl xl:text-7xl">
              Go for advertising
              <span className="block text-orange-500 mt-1">think digital</span>
            </h1>
          </Reveal>

          <Reveal delay={0.35}>
            <p className="mt-6 text-slate-300 text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
              Partner with one of the best web designers in Liberia. As a top web design
              company in Monrovia, we deliver powerful web &amp; software solutions that
          ...
          <Reveal delay={0.6}>
            <div className="mt-10 inline-flex items-center gap-3 rounded-2xl glass px-4 py-3">
              <div className="relative">
                <span className="absolute inset-0 rounded-full bg-orange-400/40 animate-ping" style={{ animation: "ping-ring 2s ease-out infinite" }} />
                <div className="relative grid place-items-center w-10 h-10 rounded-full bg-orange-500 text-white font-bold">450+</div>
              </div>
        ...
        <Reveal direction="scale" delay={0.3} className="relative">
          ...
          >
            ...
            <div className="bg-[#1e1e1e] p-5 sm:p-7 font-mono text-xs sm:text-sm overflow-x-auto">
          ...
          <button
            ...
            className="group absolute -bottom-6 -left-2 sm:-left-6 grid place-items-center w-20 h-20 rounded-full bg-orange-500 text-white shadow-xl shadow-orange-500/40 transition-transform hover:scale-105"
          >
            <span className="absolute inset-0 rounded-full border-2 border-orange-400/40 animate-ping" style={{ animation: "ping-ring 2.2s ease-out infinite" }} />
