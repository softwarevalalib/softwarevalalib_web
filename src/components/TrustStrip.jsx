...
export default function TrustStrip() {
  return (
    <section className="bg-white section-padding transition-colors duration-300">
        ...
        <Reveal delay={0.1}>
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-6 sm:gap-x-16">
            {BRANDS.map((b) => (
              <span
                key={b}
                className="text-xl sm:text-2xl font-display font-bold text-slate-400 hover:text-[#c10020] transition-colors duration-300 grayscale hover:grayscale-0"
              >
                {b}
              </span>
            ))}
